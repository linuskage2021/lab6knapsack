...
It takes about 0.3 seconds to implement the function.
...
The needed time to implement the function with n=500 is about 28 seconds.
...
It takes 0.3 seconds to implement the greedy_knapsack function.
...
When running `profvis()`, we noticed a bottleneck in the dynamic programming. We use a nested for loop and if-else statement which took a long time to compute. 
